...
} from "../deepseek-models.ts";
import { WEB_SEARCH_MODES } from "../web-search-config.ts";
...
export const sendChatSchema = z.object({
  ...
  model: z.preprocess(normalizeDeepSeekModel, z.enum(DEEPSEEK_MODELS).default(DEFAULT_DEEPSEEK_MODEL)),
